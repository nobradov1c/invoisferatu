    ...
    <div className="grid·min-h-screen·grid-rows-[20px_1fr_20px]·items-center·justify-items-center·gap-16·p-8·pb-20·font-sans·sm:p-20">
      <main className="row-start-2·flex·flex-col·items-center·gap-[32px]·sm:items-start">
        ...
        <div className="flex·flex-col·items-center·gap-4·sm:flex-row">
          <a
            className="lex·h-10·items-center·justify-center·gap-2·rounded-full·border·border-transparent·border-solid·bg-foreground·px-4·font-medium·text-background·text-sm·transition-colors·hover:bg-[#383838]·sm:h-12·sm:w-auto·sm:px-5·sm:text-base·dark:hover:bg-[#ccc]"
